...
public class EntityDieselEnergyGeneratorCar extends LiquidTank implements IFluidHandler {
	...
	public boolean isTransferingPower = false;
	public EntityDieselEnergyGeneratorCar(World world) {
	...
	public EntityDieselEnergyGeneratorCar(World world, double d, double d1, double d2) {
		this(world);
	...
	public String getInventoryName() {
		return "Diesel Energy Generator Car";
	}
