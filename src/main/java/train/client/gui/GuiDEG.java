...
public class GuiDEG extends GuiContainer {
	...
	public EntityDieselEnergyGeneratorCar degMinecart;
	public GuiDEG(EntityPlayer player, InventoryPlayer inventoryplayer, Entity entityminecart) {
		...
		this.player = player;
		this.degMinecart = ((EntityDieselEnergyGeneratorCar)entityminecart);
	}
